...
# Minimal logging config that ensures exceptions and stack traces are
# sent to stdout so they appear in Render / gunicorn logs. This helps
# debugging when DEBUG=False and there's no access to the remote shell.
LOGGING = {
    'version': 1,
